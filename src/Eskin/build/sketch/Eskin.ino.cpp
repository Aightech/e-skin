#include <Arduino.h>
#line 1 "/home/adev/dev/IC/fsr_array/src/Eskin/Eskin.ino"
#include "fsr.hpp"
#include "lis3dh.h"
...
int aa = 1;
#line 44 "/home/adev/dev/IC/fsr_array/src/Eskin/Eskin.ino"
void acc_callback();
#line 61 "/home/adev/dev/IC/fsr_array/src/Eskin/Eskin.ino"
void fsr_callback();
#line 75 "/home/adev/dev/IC/fsr_array/src/Eskin/Eskin.ino"
void setup();
#line 101 "/home/adev/dev/IC/fsr_array/src/Eskin/Eskin.ino"
void loop();
#line 44 "/home/adev/dev/IC/fsr_array/src/Eskin/Eskin.ino"
...
loop()
{
    if(Serial.available() > 0)
    {
        ...
        case 0:             //request 1 FSR array of size*size elements
            ...
            interrupts();
            break;
        case 1: //request 2 FSR array of size*size elements
            noInterrupts();
            size_fsr = size;
            layers_fsr = 2;
            size_acc = 0;
            ...
            if(ts_fsr != 0)
            {
                Serial.write((uint8_t *)&fsr_data, 4 * size * size);
                ts_fsr = 0;
            }
            interrupts();
            break;
